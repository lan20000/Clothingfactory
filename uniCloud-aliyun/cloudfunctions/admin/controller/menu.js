...
module.exports = {
	...
	listByType: async function(e) {
		...
		var dataInDB = await Menu.where({
			type
		}).orderBy("orderNum", "asc").field({
			name: true
		}).get();
	...
	save: async function(res) {
		...
		console.log('子菜单添加.========')
		await this.setMaxOrderNum(data, Menu, {
