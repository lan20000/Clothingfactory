<template>
	<labels :title="title" :titleWidth="titleWidth" :isTop="isTop" :isVertical="isVertical" :noPadding="noPadding">
		<view class="clear father" style="left: -5px;">
			...
			<files :type="type" :valueKey="valueKey?valueKey:'url'" class="fl" :list="fileList" :width="width" :count="count" @remove="remove" :disabled="false">
				
				<view class="father pd5" @tap="chooseFile" v-if="list.length < count || count == -1" :style="{width:width+'px'}">
					<view class="square">
